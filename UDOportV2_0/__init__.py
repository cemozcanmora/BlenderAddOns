bl_info = {
    ...
    "description": "Export FBX files and blendshape animations to Unity",
    "warning": "",
    "doc_url": "",
...
def register():
    ...
    bpy.types.Scene.udo_ui_props = bpy.props.PointerProperty(
        type=properties.UIProperties
    )
...
def unregister():
    ...
    del bpy.types.Scene.udo_ui_props
