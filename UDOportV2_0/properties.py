...
class UIProperties(PropertyGroup):
    ...
    fbx_section_expanded: BoolProperty(
        name="FBX Section Expanded",
        description="Whether the FBX export section is expanded",
        default=True
    )
    
    animation_section_expanded: BoolProperty(
        name="Animation Section Expanded", 
        description="Whether the animation export section is expanded",
        default=True
    )
